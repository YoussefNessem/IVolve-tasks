...
- Verify communication between containers on the same network.
- Compare communication between the custom network and the default bridge network.

[Lab 8 - Custom Network](lab8-custom-network/)